 ...
 */
public class ForgotPass1Fragment extends BaseFragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_forgot_pass1, container, false);
        return view;
    }
        ...
        btnNext.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (TextValidation.emailValidation(emailStr)) {
                    try {
                        if (requestForgotPassword(emailStr).equals(Constants.SUCCESS)) {
                            FragmentTransaction ft = getFragmentManager().beginTransaction();
                            ft.replace(R.id.frame_layout_forgot, new ForgotPass2Fragment());
    ...
    public String requestForgotPassword(final String email) throws InterruptedException {
        ...
        Thread threadForgPass = new Thread(new Runnable() {
            ...
            public void run() {
                ...
                Call<ForgotPasswordResponse> call = apiInterface.forgotPassword(uniqueID, Constants.HEADER_AGENT, Constants.HEADER_VERSION, token[0],
                        new ForgotPassword(email));

                try {
                    Response<ForgotPasswordResponse> resp = call.execute();
