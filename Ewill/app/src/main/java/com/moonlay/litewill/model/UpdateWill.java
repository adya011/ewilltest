...
public class UpdateWill {
    ...
    public UpdateWill(int id, String name) {
        this.id = id;
        this.name = name;
    }

    public UpdateWill(int id, String name, boolean isLFStatus, boolean isLFShared, boolean isLFLocationShared, boolean isLFDocumentShared, boolean isPAStatus, boolean isPAShared, boolean isPALocationShared, boolean isPADocumentShared, boolean isUserStatus, boolean isUserShared, boolean isUserLocationShared, boolean isUserDocumentShared) {
        this.id = id;
        this.name = name;
