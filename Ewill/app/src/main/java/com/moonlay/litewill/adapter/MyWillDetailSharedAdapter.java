...
public class MyWillDetailSharedAdapter extends RecyclerView.Adapter<MyWillDetailSharedAdapter.ViewHolder> {

    private ArrayList<Shared> sharedList;

    public MyWillDetailSharedAdapter(ArrayList<Shared> sharedList) {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.list_will_notify, parent, false);
